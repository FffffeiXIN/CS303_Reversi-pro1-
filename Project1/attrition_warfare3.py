...
if __name__ == "__main__":
    ...
    v2_white = submit_v2.AI(8,1,10)
    v2_black = submit_v2.AI(8,-1,10)
    ...
    for i in range(2):
        game1 = pg.play_game_1(v2_black, ab2_white)
        print(game1)
        game2 = pg.play_game_2(v2_white, ab2_black)
        print(game2)

    print("ab2 win : " + str(ab2_white.win + ab2_black.win))
    print("v2 win : " + str(v2_white.win + v2_black.win))
